        ...
        <xsl:if test="(subfield[@id='a'] or subfield[@id='i'])">
            ...
            <xsl:for-each select="subfield">
                <xsl:choose>
                    ...
                    <xsl:when test="@id='v'"> <xsl:text>. </xsl:text> <xsl:value-of
        ...
        <xsl:if test="indicator[@id ='2'][1]= ' '">
            <xsl:for-each select="subfield[@id='a']">
                <field name="subject_heading">
                    <xsl:value-of select="."/>
                    <xsl:if test="../subfield[@id='x']"> — <xsl:value-of select="../subfield[@id='x']"/>
                    </xsl:if>
                </field>
            </xsl:for-each>
        </xsl:if>
...
<xsl:template name="Date-of-publication">
    ...
    <xsl:choose>
        <xsl:when test="field[@id='461']/subfield[@id='1']/field[@id='210']/subfield[@id='d'] and not(field[@id='463']/subfield[@id='1']/field[@id='210']/subfield[@id='d']) and not(field[@id='210']/subfield[@id='d'][1])">
...
<xsl:template name="Cover">
    <xsl:for-each select="field[@id='950']/subfield[@id='a']">
        <field name="cover"><xsl:value-of select="."/></field>
    </xsl:for-each>
</xsl:template>
...
<xsl:template name="bbk">
    <xsl:for-each select="field[@id='676']/subfield[@id='a']">
        <field name="bbk">
            <xsl:value-of select="."/>
        </field>
    </xsl:for-each>
